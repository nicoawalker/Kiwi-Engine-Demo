...
DefaultShader::DefaultShader( std::wstring shaderName, Kiwi::Renderer* renderer ) :
	Kiwi::IShader( shaderName, renderer, L"Data\\Shaders\\EmptyVertexShader.cso", L"Data\\Shaders\\EmptyPixelShader.cso" )
{
...
void DefaultShader::SetFrameParameters( Kiwi::Scene* scene )
{
...
void DefaultShader::SetObjectParameters( Kiwi::Scene* scene, Kiwi::RenderTarget* renderTarget, Kiwi::Mesh::Submesh* meshSubset )
{
